...
| **Frontend Observability** | `gcx frontend` | `frontend apps list`, `frontend apps list-replay-sessions <app>`, `frontend sessions get`, `frontend sessions get-replay <session-id> --app <app> --save replay.json` |
