...
- Agent Observability: add experimental `gcx agento11y experiments export-conversations` to write lossless, checksummed experiment conversation bundles for offline analysis and fine-tuning dataset curation.
