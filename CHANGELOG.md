...
- Agent Observability: add experimental `gcx agento11y experiments export-conversations` to write private, lossless, checksummed experiment conversation bundles with generated agent-handling guidance and Git-ignore protection for offline analysis and fine-tuning dataset curation.
