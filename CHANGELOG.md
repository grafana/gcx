...
- Agent Observability: add experimental `gcx agento11y experiments export` to write private, lossless, checksummed experiment bundles with optional conversation payloads, generated agent-handling guidance, and Git-ignore protection for offline analysis and fine-tuning dataset curation.
