...
// listResponse is the wire shape for the SLO list endpoint.
type listResponse struct {
	SLOs []Slo `json:"slos"`
}

// createResponse is the wire shape for the SLO create endpoint: it carries
// only the server-assigned UUID, not the full definition.
