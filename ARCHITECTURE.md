...
| [021](docs/adrs/datasources-transport-unification/001-first-class-typed-datasources.md) | First-class typed datasources: transport unification via extended TypedCRUD | proposed |
