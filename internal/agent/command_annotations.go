...
var commandAnnotations = map[string]annotation{
	...
	"gcx irm oncall integrations get-templates":           {Cost: "medium", Hint: "<id> -o json; the whole alert template document of one integration (about 20 fields). Edit it, then apply it with set-templates."},
	"gcx irm oncall integrations set-templates":           {Cost: "small", Hint: "<id> -f templates.json; pass the document that get-templates emits"},
