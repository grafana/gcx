...
var commandAnnotations = map[string]annotation{
	...
	"gcx irm oncall escalation-policies move":            {Cost: "small", Hint: "<id> --position <n>; zero-based. Set the order at create time through spec.position."},
	...
	"gcx irm oncall routes move":                         {Cost: "small", Hint: "<id> --position <n>; zero-based, routes match top down. Set the order at create time through spec.position."},
