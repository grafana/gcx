...
var commandAnnotations = map[string]annotation{
	...
	"gcx assistant investigations chat":              {Cost: "large", Hint: "<id> [--role=user|assistant|tool] [--include-hidden] -o json; full Lodestone chat thread with tool calls and results"},
	...
	"gcx assistant investigations repair-mermaid":    {Cost: "medium", Hint: "<id> <element-id> [--message=...] -o json"},
	...
	"gcx assistant investigations skills":            {Cost: "medium", Hint: "<id> -o json; Skill matches (search_skills tool results)"},
	"gcx assistant investigations state":             {Cost: "large", Hint: "<id> -o json; returns full Lodestone session state (plan, hypotheses, mode, report)"},
	...
	"gcx assistant investigations update-mermaid":    {Cost: "small", Hint: "<id> <element-id> --content=path|-"},
