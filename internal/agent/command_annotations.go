...
var commandAnnotations = map[string]annotation{
	...
	"gcx alert notification-history list-alerts": {Cost: "medium", Hint: "--uuid <uuid> --since 1h -o json"},
	...
	// k6 provider
	// -----------------------------------------------------------------------
	"gcx k6 auth validate":                      {Cost: "small"},
	...
	"gcx k6 load-tests get-schedule":            {Cost: "small"},
	"gcx k6 load-tests get-script":              {Cost: "large", Hint: "<load-test-id> --type javascript > script.js"},
	"gcx k6 load-tests list":                    {Cost: "small"},
	"gcx k6 load-tests list-metrics":            {Cost: "medium", Hint: "<load-test-id> [--run-count <count> | --run-id <id>] -o json"},
	"gcx k6 load-tests move":                    {Cost: "small"},
	"gcx k6 load-tests query":                   {Cost: "medium", Hint: "<load-test-id> 'increase' --metric http_reqs --run-count 5 -o json"},
	"gcx k6 load-tests start":                   {Cost: "small", Hint: "<load-test-id> [--idempotency-key <key>]. Starting a test consumes billable VU hours (" + docs.PerformanceTestingInvoice + ")."},
	"gcx k6 load-tests update":                  {Cost: "small"},
	"gcx k6 load-tests update-script":           {Cost: "small"},
	"gcx k6 label-keys create":                  {Cost: "small", Hint: "-f <request.yaml>"},
	"gcx k6 label-keys delete":                  {Cost: "small"},
	"gcx k6 label-keys list":                    {Cost: "small"},
	"gcx k6 label-keys update":                  {Cost: "small", Hint: "<id> -f <patch.yaml>"},
	...
	"gcx k6 projects get-limits":                {Cost: "small"},
	"gcx k6 projects list":                      {Cost: "small"},
	"gcx k6 projects list-allowed-load-zones":   {Cost: "small"},
	"gcx k6 projects list-labels":               {Cost: "small"},
	"gcx k6 projects update":                    {Cost: "small"},
	"gcx k6 projects update-allowed-load-zones": {Cost: "small"},
	"gcx k6 projects update-labels":             {Cost: "small", Hint: "<project-id> -f <replacement.yaml> --force"},
	"gcx k6 projects update-limits":             {Cost: "small", Hint: "<project-id> -f <patch.yaml>"},
	"gcx k6 project-limits list":                {Cost: "small"},
	"gcx k6 options validate":                   {Cost: "small", Hint: "-f <request.yaml>"},
	"gcx k6 runs abort":                         {Cost: "small"},
	"gcx k6 runs artifacts download":            {Cost: "small", Hint: "<run-id> [artifact-path...] --output-dir <dir>"},
	"gcx k6 runs artifacts list":                {Cost: "medium", Hint: "<run-id> -o json; use artifacts download to write screenshots without returning their contents"},
	"gcx k6 runs delete":                        {Cost: "small"},
	"gcx k6 runs get":                           {Cost: "small"},
	"gcx k6 runs get-distribution":              {Cost: "small"},
	"gcx k6 runs get-insights":                  {Cost: "medium", Hint: "<run-id> -o json"},
	"gcx k6 runs get-script":                    {Cost: "large", Hint: "<run-id> --type javascript > script.js"},
	"gcx k6 runs list":                          {Cost: "small"},
	"gcx k6 runs list-labels":                   {Cost: "small"},
	"gcx k6 runs list-logs":                     {Cost: "large", Hint: "<run-id> [PIPELINE] --limit 50 -o json"},
	"gcx k6 runs list-metrics":                  {Cost: "medium", Hint: "<run-id> -o json"},
	"gcx k6 runs list-series":                   {Cost: "medium", Hint: "<run-id> '<metric>{<label>=<value>}' -o json"},
	"gcx k6 runs query":                         {Cost: "large", Hint: "<run-id> 'increase' --metric http_reqs --aggregate -o json"},
	"gcx k6 runs star":                          {Cost: "small"},
	"gcx k6 runs traces get":                    {Cost: "large", Hint: "<run-id> <trace-id> --json batches"},
	"gcx k6 runs traces list":                   {Cost: "large", Hint: "<run-id> --query '<TraceQL>' --limit 50 -o json"},
	"gcx k6 runs unstar":                        {Cost: "small"},
	"gcx k6 runs update":                        {Cost: "small", Hint: "<run-id> --note <text>"},
	"gcx k6 runs wait":                          {Cost: "small", Hint: "<run-id> --timeout 15m"},
	"gcx k6 schedules activate":                 {Cost: "small"},
	"gcx k6 schedules create":                   {Cost: "small", Hint: "-f <manifest.yaml>"},
	"gcx k6 schedules deactivate":               {Cost: "small"},
	...
	"gcx irm oncall escalation-policies create":          {Cost: "small", Hint: "-f policy.yaml (run `escalation-policies list-step-types` for allowed step values)"},
	...
	"gcx irm oncall escalation-policies list-step-types": {Cost: "small"},
	"gcx irm oncall escalation-policies steps list":      {Cost: "small", Hint: "Older spelling. Use `escalation-policies list-step-types`."},
	...
	"gcx irm oncall routes create":                       {Cost: "small", Hint: "-f route.yaml (run `routes list-filter-types` for filtering_term_type values)"},
	"gcx irm oncall routes delete":                       {Cost: "small"},
	"gcx irm oncall routes filter-types list":            {Cost: "small", Hint: "Older spelling. Use `routes list-filter-types`."},
	...
	"gcx irm oncall webhooks create":                     {Cost: "small", Hint: "-f webhook.yaml (run `webhooks list-triggers` and `webhooks list-presets` for allowed values)"},
	"gcx irm oncall webhooks delete":                     {Cost: "small"},
	"gcx irm oncall webhooks get":                        {Cost: "small"},
	"gcx irm oncall webhooks list":                       {Cost: "small"},
	"gcx irm oncall webhooks list-presets":               {Cost: "small"},
	"gcx irm oncall webhooks list-triggers":              {Cost: "small"},
	"gcx irm oncall webhooks presets list":               {Cost: "small", Hint: "Older spelling. Use `webhooks list-presets`."},
	"gcx irm oncall webhooks triggers list":              {Cost: "small", Hint: "Older spelling. Use `webhooks list-triggers`."},
	...
	"gcx profiles series":             {Cost: "large", Hint: `--match '{service_name="frontend"}' --label-name namespace --label-name pod --since 1h -o json`},
