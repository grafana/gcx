...
var commandAnnotations = map[string]annotation{
	...
	"gcx irm oncall escalation-policies steps":      {Cost: "small"},
	...
	"gcx irm oncall routes filter-types":            {Cost: "small"},
	...
	"gcx irm oncall webhooks presets":               {Cost: "small"},
	"gcx irm oncall webhooks presets list":          {Cost: "small"},
	"gcx irm oncall webhooks triggers":              {Cost: "small"},
