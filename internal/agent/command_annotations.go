...
var commandAnnotations = map[string]annotation{
	...
	"gcx irm oncall escalation-policies update-position": {Cost: "small", Hint: "<id> --position <n>; zero-based. A create-time spec.position is an insertion point, not an absolute index; this verb sets a known index."},
	...
	"gcx irm oncall routes update-position": {Cost: "small", Hint: "<id> --position <n>; zero-based, routes match top down. A create-time spec.position is an insertion point, not an absolute index; this verb sets a known index."},
