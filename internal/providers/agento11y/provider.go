...
func init() { //nolint:gochecknoinits // Self-registration pattern (like database/sql drivers).
	providers.Register(&Agento11yProvider{})
}

// Agento11yProvider manages Grafana Agent Observability resources
// (backed by the upstream `grafana-agento11y-app` plugin).
type Agento11yProvider struct{}

// Name returns the unique identifier for this provider.
func (p *Agento11yProvider) Name() string { return "agento11y" }

// ShortDesc returns a one-line description of the provider.
func (p *Agento11yProvider) ShortDesc() string {
	return "Manage Grafana Agent Observability resources"
}

// Commands returns the Cobra commands contributed by this provider.
func (p *Agento11yProvider) Commands() []*cobra.Command {
	loader := &providers.ConfigLoader{}

	agento11yCmd := &cobra.Command{
		Use:   "agento11y",
		Short: p.ShortDesc(),
	...
	loader.BindFlags(agento11yCmd.PersistentFlags())
	...
	experimentsCmd.Annotations = map[string]string{
		agent.AnnotationTokenCost: "medium",
		agent.AnnotationLLMHint:   `gcx agento11y experiments list -o json; gcx agento11y experiments get <run-id> -o yaml; gcx agento11y experiments update <run-id> --description '...' --tag nightly --tag support -o json; gcx agento11y experiments list-scores <run-id> -o json; gcx agento11y experiments get-report <run-id> -o json; gcx agento11y experiments test-suites list -o json; gcx agento11y experiments test-suites cases list <suite-id> <version> -o json; gcx agento11y experiments list-trials <run-id> -o json; gcx agento11y experiments export <run-id> -d ./exports/<run-id> --include-conversations`,
	}
...
func (p *Agento11yProvider) Validate(cfg map[string]string) error {
	return nil
}
...
func (p *Agento11yProvider) ConfigKeys() []providers.ConfigKey {
	return nil
}
...
func (p *Agento11yProvider) TypedRegistrations() []adapter.Registration {
