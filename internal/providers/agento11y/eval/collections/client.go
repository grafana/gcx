...
func (c *Client) List(ctx context.Context, limit int) ([]Collection, error) {
	return agento11yhttp.ListAll[Collection](ctx, c.base, basePath, nil, limit)
}
...
func (c *Client) Get(ctx context.Context, id string) (*Collection, error) {
	col, err := agento11yhttp.DoJSONNotFound[any, Collection](ctx, c.base, http.MethodGet, basePath+"/"+url.PathEscape(id), nil,
...
func (c *Client) Create(ctx context.Context, col *Collection) (*Collection, error) {
	created, err := agento11yhttp.DoJSON[Collection, Collection](ctx, c.base, http.MethodPost, basePath, col, http.StatusOK, http.StatusCreated)
	if err != nil {
		return nil, err
	}
	return &created, nil
...
func (c *Client) Update(ctx context.Context, id string, req *UpdateRequest) (*Collection, error) {
	col, err := agento11yhttp.DoJSON[UpdateRequest, Collection](ctx, c.base, http.MethodPatch, basePath+"/"+url.PathEscape(id), req, http.StatusOK)
	if err != nil {
		return nil, err
	}
	return &col, nil
...
func (c *Client) Delete(ctx context.Context, id string) error {
	return agento11yhttp.DoStatus[any](ctx, c.base, http.MethodDelete, basePath+"/"+url.PathEscape(id), nil, http.StatusOK, http.StatusNoContent)
}
...
func (c *Client) ListMembers(ctx context.Context, id string, limit int) ([]savedconversations.SavedConversation, error) {
	...
	return agento11yhttp.ListAll[savedconversations.SavedConversation](ctx, c.base, path, nil, limit)
}
...
func (c *Client) AddMembers(ctx context.Context, id string, savedIDs []string) error {
	path := basePath + "/" + url.PathEscape(id) + "/members"
	return agento11yhttp.DoStatus(ctx, c.base, http.MethodPost, path, &AddMembersRequest{SavedIDs: savedIDs}, http.StatusOK, http.StatusCreated, http.StatusNoContent)
}
...
func (c *Client) RemoveMember(ctx context.Context, id, savedID string) error {
	...
	return agento11yhttp.DoStatus[any](ctx, c.base, http.MethodDelete, path, nil, http.StatusOK, http.StatusNoContent)
}
