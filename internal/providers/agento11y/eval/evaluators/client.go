...
func (c *Client) List(ctx context.Context) ([]eval.EvaluatorDefinition, error) {
	return agento11yhttp.ListAll[eval.EvaluatorDefinition](ctx, c.base, basePath, nil)
}
...
func (c *Client) Create(ctx context.Context, evaluator *eval.EvaluatorDefinition) (*eval.EvaluatorDefinition, error) {
	created, err := agento11yhttp.DoJSON[eval.EvaluatorDefinition, eval.EvaluatorDefinition](ctx, c.base, http.MethodPost, basePath, evaluator, http.StatusOK, http.StatusCreated)
	if err != nil {
		return nil, err
	}
	return &created, nil
...
func (c *Client) RunTest(ctx context.Context, req *eval.EvalTestRequest) (*eval.EvalTestResponse, error) {
	result, err := agento11yhttp.DoJSON[eval.EvalTestRequest, eval.EvalTestResponse](ctx, c.base, http.MethodPost, evalTestPath, req, http.StatusOK)
	if err != nil {
		return nil, err
	}
	return &result, nil
...
func (c *Client) Delete(ctx context.Context, id string) error {
	return agento11yhttp.DoStatus[any](ctx, c.base, http.MethodDelete, fmt.Sprintf(evaluatorByIDFmt, url.PathEscape(id)), nil, http.StatusOK, http.StatusNoContent)
}
