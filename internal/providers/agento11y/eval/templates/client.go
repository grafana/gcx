...
func (c *Client) List(ctx context.Context, scope string, maxItems ...int) ([]eval.TemplateDefinition, error) {
	...
	return agento11yhttp.ListAll[eval.TemplateDefinition](ctx, c.base, basePath, query, maxItems...)
}

// Get returns a single template by ID.
func (c *Client) Get(ctx context.Context, id string) (*eval.TemplateDetail, error) {
	detail, err := agento11yhttp.DoJSON[any, eval.TemplateDetail](ctx, c.base, http.MethodGet, fmt.Sprintf(templateByIDFmt, url.PathEscape(id)), nil, http.StatusOK)
	if err != nil {
		return nil, err
	}
	return &detail, nil
...
func (c *Client) ListVersions(ctx context.Context, id string) ([]eval.TemplateVersion, error) {
	return agento11yhttp.ListAll[eval.TemplateVersion](ctx, c.base, fmt.Sprintf(versionsPathFmt, url.PathEscape(id)), nil)
}
