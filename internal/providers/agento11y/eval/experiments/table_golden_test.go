...
func TestSuitesTableGolden(t *testing.T) {
	...
	testutils.AssertTableGolden(t, experiments.SuitesTable(), row, "table", "wide")
}
...
func TestCasesTableGolden(t *testing.T) {
	...
	testutils.AssertTableGolden(t, experiments.CasesTable(), row, "table", "wide")
}
...
func TestTrialsTableGolden(t *testing.T) {
	...
	testutils.AssertTableGolden(t, experiments.TrialsTable(), row, "table", "wide")
}
...
func TestArtifactsTableGolden(t *testing.T) {
	...
	testutils.AssertTableGolden(t, experiments.ArtifactsTable(), row, "table", "wide")
}
...
func TestTableGolden(t *testing.T) {
	...
	testutils.AssertTableGolden(t, experiments.Table(), row, "table", "wide")
}
...
func TestScoresTableGolden(t *testing.T) {
	...
	testutils.AssertTableGolden(t, experiments.ScoresTable(), row, "table", "wide")
}
