...
| `internal/providers/irm/sync_plugin_commands.go` | The experimental `gcx irm plugin sync` command (temporarily request a refresh of the IRM copy of the Grafana users and teams) |
