...
| [naming-conventions-guide.md](naming-conventions-guide.md) | Command naming guide (verbs, addressability) - companion to the proposed ADR in [#994](https://github.com/grafana/gcx/pull/994) |
