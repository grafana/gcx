...
Show the heading outline of a documentation page.
...
```
  ...
  -o, --output string    Output format. One of: agents, json, text, yaml (default "text")
      --product string   Scope shorthand resolution to a product (case-insensitive; matches exact, then prefix, then substring; empty = all products; ignored when the argument is a full URL)
```
