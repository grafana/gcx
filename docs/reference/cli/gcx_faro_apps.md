...
* [gcx faro](gcx_faro.md)	 - Manage Grafana Frontend Observability (Faro) resources
* [gcx faro apps apply-sourcemap](gcx_faro_apps_apply-sourcemap.md)	 - Upload a sourcemap for a Faro app.
* [gcx faro apps create](gcx_faro_apps_create.md)	 - Create a Faro app from a file.
