...
Use `gcx resources get droprules` for a full tenant listing.
...
* [gcx logs adaptive drop-rules create](gcx_logs_adaptive_drop-rules_create.md)	 - Create an adaptive log drop rule.
...
* [gcx logs adaptive drop-rules update](gcx_logs_adaptive_drop-rules_update.md)	 - Update an adaptive log drop rule.
