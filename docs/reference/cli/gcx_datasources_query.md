...
```
  ...
  -h, --help                  help for query
      ...
      --limit int             Maximum log lines for loki, or max rows for pinot (0 means no limit). Pinot uses 100 when --limit is omitted. Pinot: not applied to UNION, OFFSET, OPTION, or a trailing comment (warned on stderr) (default 50)
