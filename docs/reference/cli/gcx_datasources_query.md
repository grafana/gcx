...
```
  ...
  -h, --help                  help for query
      ...
      --limit int             Maximum number of log lines to return for loki queries (0 means no limit). If omitted, table/wide use 50 and other formats use 1000 (default 1000)
