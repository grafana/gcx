## gcx kg suppressions upsert

Upsert (create or update) one or more suppressions from a YAML file or stdin.
...
```
gcx kg suppressions upsert [flags]
```

### Examples

```
  gcx kg suppressions upsert -f suppressions.yaml
