## grafanactl kg entity-types list

List entity types with counts.

```
grafanactl kg entity-types list [flags]
```
...
* [grafanactl kg entity-types](grafanactl_kg_entity-types.md)	 - Manage Knowledge Graph entity types.
