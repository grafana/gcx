## grafanactl kg service-dashboard

Configure service dashboard settings.

### Options

```
  -h, --help   help for service-dashboard
```
...
* [grafanactl kg service-dashboard create](grafanactl_kg_service-dashboard_create.md)	 - Configure service dashboard from a file (YAML).
