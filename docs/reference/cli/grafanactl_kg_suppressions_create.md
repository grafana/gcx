## grafanactl kg suppressions create

Upload suppressions from a YAML file.

```
grafanactl kg suppressions create [flags]
```
...
* [grafanactl kg suppressions](grafanactl_kg_suppressions.md)	 - Push suppressions to the Knowledge Graph.
