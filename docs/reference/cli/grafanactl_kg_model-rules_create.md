## grafanactl kg model-rules create

Upload model rules from a YAML file.

```
grafanactl kg model-rules create [flags]
```
...
* [grafanactl kg model-rules](grafanactl_kg_model-rules.md)	 - Push model rules to the Knowledge Graph.
