...
```
  -h, --help                         help for check
      ...
      --min-pass-rate float          Lowest acceptable pass rate, 0..1 (required). Set to 0 to accept any measured rate; a rate that cannot be measured is still graded by --on-unknown. See --help for how pass_rate is measured.
