...
* [gcx kg entities create](gcx_kg_entities_create.md)	 - Create or update a custom entity (upsert).
* [gcx kg entities delete](gcx_kg_entities_delete.md)	 - Delete a custom entity.
