...
```
  ...
  -h, --help                help for query
      ...
      --limit int           Max rows to return; requests above 1000 are capped, with a warning. Not applied to UNION, OFFSET, OPTION, or a trailing comment (warned on stderr). 0 disables enforcement (default 100)
