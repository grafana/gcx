...
```
  ...
  -h, --help                help for query
      ...
      --limit int           Max rows to return; requests above 1000 are capped, with a warning. Not applied to UNION, OFFSET, or OPTION queries (warned on stderr). 0 disables enforcement (default 100)
