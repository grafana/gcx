...
| `docs/architecture/` | Yes — run structural checks below |
| `docs/reference/cli/` | Automatic — `mise run reference` regenerates CLI reference |
...
| `docs/reference/cli/` | Automatic — `mise run reference` regenerates |
...
6. **Run `mise run reference`** after any CLI changes — regenerates reference docs.
