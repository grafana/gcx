...
const wantUnsupportedMessage = `datasource type "tempo" is not supported ` +
	`(supported: azuremonitor, bigquery, clickhouse, cloudmonitoring, cloudwatch, elasticsearch, influxdb, loki, mssql, mysql, opensearch, postgres, prometheus, pyroscope)`
