...
require (
	...
	github.com/grafana/loki/v3 v3.7.1 // pinned: v3.5+ uses loki/pkg/push pseudo-versions not on Go proxy (monorepo replace directive)
	...
	github.com/prometheus/prometheus v0.310.1-0.20260320085417-166d20151c0d // pinned: v0.311+ requires strfmt v0.26+ which triggers go-openapi/testify/v2 assert/yaml removal bug
